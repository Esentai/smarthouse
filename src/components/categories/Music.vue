<template>
  <div class="container">
    <div class="content">
      <b-button class="addBtn" variant="primary" v-b-modal.modal-prevent-closing>Add new music device</b-button>
      <b-modal id="modal-prevent-closing" ref="modal" title="Add new music device" @show="resetModal" @hidden="resetModal" @ok="handleOk">
      ...
      <div class="item" v-for="device in devices" :key="device.deviceID">
        ...
        <b-button class="itemBtn" variant="primary" @click="watchBtn" >Play</b-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    watchBtn(){
      this.$alert(`Music playback error!`);
    }
